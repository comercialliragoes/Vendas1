...
menu = st.sidebar.selectbox(
    'Escolha uma Opção',
    ['Lista de Vendas', 'Produtos','Vendas','Atualizar Precos','Importacao DeepSeek'],
    index=['Lista de Vendas', 'Produtos','Vendas','Atualizar Precos','Importacao DeepSeek'].index(st.session_state["sessao_Atual"])
)
...
if menu != st.session_state["sessao_Atual"]:
    ...
    st.session_state["id_venda_atual"] = None  # Reseta o aluno sendo editado
